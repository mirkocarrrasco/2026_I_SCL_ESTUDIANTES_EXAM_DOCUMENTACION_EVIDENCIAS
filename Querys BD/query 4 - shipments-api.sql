...
SELECT id, email, name, phone_number, web_site FROM public.shipping_companies;
SELECT id, address, latitude, longitude, order_id, reference, status, shipment_company_id FROM public.shipments;
